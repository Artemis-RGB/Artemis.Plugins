...
public class AudioVisualizationService : IPluginService, IDisposable
{
    ...
    private readonly IAudioEnumerationService _audioDeviceEnumerationService;
    ...
    public AudioVisualizationService(Plugin plugin, ICoreService coreService, IAudioEnumerationService audioDeviceEnumerationService, PluginSettings pluginSettings, ILogger logger)
    {
        _profiler = plugin.GetProfiler("AudioVisualizationService");
        _coreService = coreService;
        _audioDeviceEnumerationService = audioDeviceEnumerationService;
        _logger = logger;
        ...
        _audioDeviceEnumerationService.DefaultDeviceChanged += NotificationClient_DefaultDeviceChanged;
    }
    ...
    private void Activate()
    {
        lock (this)
        {
            ...
            _audioInput = _audioDeviceEnumerationService.CreateDefaultAudioInput(_useCustomWasapiCapture.Value);
