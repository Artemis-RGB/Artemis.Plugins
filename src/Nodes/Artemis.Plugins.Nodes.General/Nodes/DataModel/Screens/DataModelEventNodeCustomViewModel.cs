...
public class DataModelEventNodeCustomViewModel : CustomNodeViewModel
{
    ...
    public DataModelEventNodeCustomViewModel(DataModelEventNode node, INodeScript script, IDataModelUIService dataModelUIService, INodeEditorService nodeEditorService, INodeService nodeService)
        : base(node, script)
    {
        _node = node;
