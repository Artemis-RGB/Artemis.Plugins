...
public class DataModelNodeCustomViewModel : CustomNodeViewModel
{
    ...
    public DataModelNodeCustomViewModel(DataModelNode node, INodeScript script, IDataModelUIService dataModelUIService, INodeEditorService nodeEditorService, INodeService nodeService) 
        : base(node, script)
    {
        _node = node;
