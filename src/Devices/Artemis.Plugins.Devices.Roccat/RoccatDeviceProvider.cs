...
namespace Artemis.Plugins.Devices.Roccat
{
    ...
    public class RoccatDeviceProvider : DeviceProvider
    {
        ...
        public override void Enable()
        {
            ...
            RGB.NET.Devices.Roccat.RoccatDeviceProvider.PossibleX64NativePaths.Add(Path.Combine(Plugin.Directory.FullName, "x64", "RoccatTalkSDKWrapper.dll"));
            RGB.NET.Devices.Roccat.RoccatDeviceProvider.PossibleX86NativePaths.Add(Path.Combine(Plugin.Directory.FullName, "x86", "RoccatTalkSDKWrapper.dll"));
