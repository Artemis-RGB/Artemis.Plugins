...
public class CaptureScreenNodeConfigurationDialogViewModel : DialogViewModelBase<bool>
{
    ...
    private readonly CaptureScreenNodeStorage _properties;
    ...
    public CaptureScreenNodeConfigurationDialogViewModel(IWindowService windowService) : base()
    {
    ...
    public void Save()
    {
        ...
        _properties.FlipHorizontal = FlipHorizontal;
        _properties.FlipVertical = FlipVertical;
        _properties.DownscaleLevel = DownscaleLevel;

        _properties.BlackBarDetectionTop = BlackBarDetectionTop;
        _properties.BlackBarDetectionBottom = BlackBarDetectionBottom;
        _properties.BlackBarDetectionLeft = BlackBarDetectionLeft;
        _properties.BlackBarDetectionRight = BlackBarDetectionRight;
        _properties.BlackBarDetectionThreshold = BlackBarDetectionThreshold;

        if (SelectedCaptureScreen != null)
        {
            _properties.GraphicsCardVendorId = SelectedCaptureScreen.Display.GraphicsCard.VendorId;
            _properties.GraphicsCardDeviceId = SelectedCaptureScreen.Display.GraphicsCard.DeviceId;
            _properties.DisplayName = SelectedCaptureScreen.Display.DeviceName;

            _properties.CaptureFullScreen = X == 0 &&
                                                          Y == 0 &&
    ...
    private async Task<bool> CreateCaptureScreens()
    {
        ...
        SelectedCaptureScreen = CaptureScreens.FirstOrDefault(s => s.Display.GraphicsCard.VendorId == _properties.GraphicsCardVendorId &&
                                                                   ...
                                                                   s.Display.DeviceName == _properties.DisplayName) ?? CaptureScreens.First();
